// polyP6-exoExp : analyse syntaxique d'expressions 
// + traitement des expressions dirigé par la syntaxe (affichages)
// 
// A. GRAZON - V.MASSON
...
// et lance son analyse (appelée compilation) à partir de l'axiome "unite" de la grammaire Exp2.g
// il est prévu de pouvoir analyser plusieurs textes source de suite (arrêt par un retour-chariot)
